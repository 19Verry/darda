                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.slideshow.store') }}" method="POST"
                                    ...
                                    <tbody class="align-middle">
                                        <?php foreach ($Slideshow as $index => $item): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('assets/img/hero-carousel/' . $item->gambar) }}"
                                                        width="100" alt="Gambar untuk <?php echo htmlspecialchars($item['judul']); ?>"
                                                        class="ms-3">
                                                </td>
                                                        ...
                                                        <div class="modal fade" id="editModal{{ $item->id }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.slideshow.update', $item->id) }}"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    for="judulslideshow{{ $item->id }}"
                                                                                    class="form-label">Judul</label>
                                                                                <input class="form-control" type="text"
                                                                                    id="judulslideshow{{ $item->id }}"
                                                                                    name="judul"
                                                                                    value="{{ $item->judul }}">
                                                                            </div>
                                                                            <!-- Input untuk deskripsi slideshow -->
