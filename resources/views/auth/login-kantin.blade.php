                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                                ...
                                <p class="text-center small">Login Kantin untuk Orang Tua Santri</p>
                            </div>

                            <form class="row g-3 needs-validation" action="/kantin">

                                <div class="col-12">
                                    <label for="yourUsername" class="form-label">NISN</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="password" name="password" class="form-control" id="yourPassword"
                                        placeholder="Masukkan Password Santri">
                                </div>
                                <div class="col-12">
